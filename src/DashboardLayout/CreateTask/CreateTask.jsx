...
const CreateTask = ({ tasks, setTasks }) => {
  ...
  return (
    <div>
      <div className=" bg-green-50 py-5  mb-10 ">
        <h1 className="text-center text-orange-400 text-3xl font-bold drop-shadow-xl ">
          Added Your Task
        </h1>
            ...
            <div>
              <div className=" mx-auto ">
                ...
                >
                  ...
                  <button className="btn bg-orange-400 btn-sm text-white block mx-auto hover:bg-orange-600 drop-shadow-lg px-8 mt-5">
                    Add Task
                  </button>
                </form>
              </div>
